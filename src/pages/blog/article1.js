...
export default function article1({ data }) {
  return (
    <>
      <article class="max-w-full px-6 py-24 mx-auto space-y-12 dark:bg-gray-800 dark:text-gray-50">
        <div class="w-full mx-auto space-y-4 text-center">
          ...
          <p class="text-sm dark:text-gray-400">
            ...
            >
              <span itemprop="name"> {data.mdx.frontmatter.author}</span>
            </a>
          </p>
        </div>
        <div class="px-24 dark:text-gray-100">
          <p>{data.mdx.body}</p>
        </div>
...
export const query = graphql`
  query MyQuery {
    mdx(frontmatter: { slug: { eq: "article1" } }) {
      body
      frontmatter {
        title
        author
