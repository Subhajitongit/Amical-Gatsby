...
export default function Pricing() {
  return (
    <div className="w-full bg-blue-100">
      <div className="container my-15 mx-auto bg-blue-100 ">
        {/* <!-- Section: Design Block --> */}
        <section className="pb-10 text-gray-800">
          <div
            className="background-radial-gradient text-center text-white"
          >
            <h2 className="text-3xl font-bold text-center mb-12 text-black pt-16 tracking-widest">
              PRICING
            </h2>
          </div>
